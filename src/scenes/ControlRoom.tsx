...
export function ControlRoom({ room, active }: { room: RoomDefinition; active: boolean }) {
  return (
    <group>
      <RoomShell
        width={17}
      ...
      <LedWall active={active} url="/assets/screens/room-04-wall.webp" radius={8.7} arc={2.55} height={4.7} y={1.75} />
      ...
      <CeilingFan active={active} ceilingY={4.86} position={[-4.6, 1.4]} scale={1.35} speed={0.7} />
      <CeilingFan active={active} ceilingY={4.86} position={[4.6, 1.4]} scale={1.35} speed={0.62} />
