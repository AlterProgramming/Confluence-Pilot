...
export const sceneConfigs: Record<string, SceneConfig> = {
  '02': { floor: 'wood-floor', wall: 'plaster', wallColor: '#e7dccb', glazing: 'left' },
  ...
  '06': { floor: 'concrete', wall: 'metal-panel', wallColor: '#c8ccd0' },
  ...
  '09': { floor: 'metal-panel', wall: 'plaster', wallColor: '#d8dae2' },
  '10': { floor: 'metal-panel', wall: 'metal-panel', wallColor: '#ccd2d8' },
  '11': { floor: 'marble', wall: 'marble', wallColor: '#ece9e4', floorRoughness: 0.3, glazing: 'right' },
  '12': { floor: 'wood-floor', wall: 'plaster', wallColor: '#ece0cd', glazing: 'left' },
};
